...
<style lang='scss' scoped>
  ...
  .title {
    width: 388px;
    height: 79px;
    background: url("../assert/顶部导航栏_LOGO背景.png") no-repeat;
  ...
  .logo-img {
    width: 28px;
    height: 31px;
    background: url("../assert/LOGO.png") no-repeat;
    background-size: contain;
    margin-right: 20px;
  }
  .tab {
  ...
  .sanjiao {
    ...
    margin-left: -6px;
    z-index: 10;
    background: url("../assert/sanjiao.png") no-repeat;
    background-size: contain;
  }
  .tab.active {
  ...
  .tab-line {
    width: 10px;
    height: 30px;
    background: url("../assert/顶部导航栏_标题分割线.png") no-repeat;
    background-size: contain;
  }
  .time-box {
    width: 327px;
    height: 39px;
    background: url("../assert/顶部导航栏_时间框背景.png") no-repeat;
    background-size: contain;
    margin-left: 153px;
    margin-right: 53px;
    color: #cde4ff;
  ...
  .right1 {
    width: 128px;
    height: 54px;
    background: url("../assert/顶部导航栏_缩放背景.png") no-repeat;
    background-size: contain;
    position: relative;
  }
  .right2 {
    width: 78px;
    height: 78px;
    background: url("../assert/顶部导航栏_人物信息icon_背景.png") no-repeat;
    background-size: contain;
    position: absolute;
    top: 0;
    right: 0;
  ...
  .people {
    width: 34px;
    height: 36px;
    background: url("../assert/顶部导航栏_人物信息icon.png") no-repeat;
    background-size: contain;
    @include center;
  }
  .r-btn {
    width: 35px;
    height: 35px;
    background: url("../assert/顶部导航栏_缩放icon.png") no-repeat;
    background-size: contain;
    @include center;
  }
  .header-box {
